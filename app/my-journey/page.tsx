        ...
        <main className="min-lg:w-3/4">
                ...
                <div className="flex gap-4">
                    <div className=" border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
                        <div className="flex items-center gap-2">
                            <Image src="/icons/check.svg" alt="checkmark" width={22} height={2} />
                    ...
                    <div className=" border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
                        <div className="flex items-center gap-2">
                            <Image src="/icons/cap.svg" alt="cap" width={22} height={2} />
            ...
            <Accordion type="multiple" >
                ...
                <AccordionItem value="companions">
                    ...
                    <AccordionContent>
                        <CompanionsList title="My Copanions" companions={companions}/>
                    </AccordionContent>
                </AccordionItem>
            </Accordion>
        </main>
